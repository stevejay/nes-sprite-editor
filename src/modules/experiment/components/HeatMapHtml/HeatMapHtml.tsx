...
import styles from "./HeatMapHtml.module.scss";
import HeatMapHtmlChart from "./HeatMapHtmlChart";
...
class HeatMapHtml extends React.Component<Props, State> {
